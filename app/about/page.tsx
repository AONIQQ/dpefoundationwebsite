  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 font-serif">
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold mb-6 text-center text-black dark:text-white">Foundation History</h2>
          <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-lg text-sm sm:text-base space-y-4">
            <p>The Foundation was originally formed in 1960 by student, alumni and faculty by Brothers of Alpha Chapter of Delta Phi Epsilon Fraternity and was later incorporated with the adoption of a Certificate of Incorporation on May 16, 1962 and filed in District of Columbia on May 23, 1962.</p>
            ...
            <p>No fundraising or meaningful programming activities were conducted.</p>
            ...
            <p>A decision was made to expand the activities of the Foundation and seek tax exempt status for the organization. Alpha Chapter Brother Albert L Grasso, a tax attorney, volunteered to apply to the Internal Revenue Service for exemption pursuant to Section 501(c)(3) of the Internal Revenue Code.</p>
            ...
            <p>Following a decision by Georgetown University to require most undergraduate students to reside in university housing, maintenance of the Alpha Chapter fraternity house as a residence for undergraduate brothers became untenable. The undergraduate brothers of Alpha Chapter, with the support of substantial alumni Alpha Chapter brothers who expressed an opinion, decided to donate the house to the Foundation with the expectation of a sale. Due to the tax exempt status of the Foundation, the sales proceeds would not be reduced by taxes. A sale by the fraternity would be taxable.</p>
            ...
            <p>Brothers Stewart, Picozzi and Eriksen continue to serve as of the current date. The other Trustees were replaced by Carlos Roa, Kenneth W Bleakley (recently deceased), Albert L Grasso and Timothy J Rosenberger.</p>
          </div>
        </section>
